...
from nova.core.history import HistoryManager, HistoryError
...
class TestHistoryManager:
    ...
    def test_save_conversation_adds_md_extension(self, history_dir, sample_conversation):
    ...
    def test_load_conversation_from_fixture(self, history_dir):
        ...
        with open(fixture_path, 'r') as src, open(test_file, 'w') as dst:
            dst.write(src.read())
    ...
    def test_roundtrip_conversion(self, history_dir, sample_conversation):
        ...
        for original, loaded in zip(sample_conversation.messages, loaded_conv.messages):
