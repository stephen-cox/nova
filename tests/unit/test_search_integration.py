...
class TestSearchIntegration:
    ...
    async def test_end_to_end_search_workflow(self):
        ...
        with patch.object(manager, '_execute_enhanced_searches') as mock_execute, \
             patch.object(manager, '_enhance_results_with_content') as mock_enhance:
            ...
            ], {"provider": "DuckDuckGo", "total_time_ms": 500})
            ...
            enhanced_result = SearchResult(
                ...
                snippet="Original snippet",
                source="example.com",
                enhanced_snippet="Enhanced content summary"
            )
            ...
            assert result["results"][0]["enhanced_snippet"] == "Enhanced content summary"
    ...
    async def test_concurrent_search_execution(self):
        ...
        from nova.search.models import EnhancedSearchQuery, EnhancedSearchPlan
    ...
    async def test_configuration_validation_integration(self):
        ...
        assert "google" not in providers or len([p for p in providers if "google" in p.lower()]) == 0
