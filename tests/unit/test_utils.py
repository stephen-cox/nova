...
from nova.utils.files import ensure_dir, safe_filename, get_user_data_dir, get_user_config_dir
from nova.utils.formatting import (
    print_message, print_error, print_success, print_warning, print_info, 
    format_file_size
)
...
class TestFileUtils:
    ...
    @pytest.mark.skip(reason="Cross-platform path testing complex - Windows paths on Linux")
...
class TestFormattingUtils:
    ...
    def test_print_error(self, mock_console):
        ...
        mock_console.print.assert_called_once_with("[red bold]Error:[/red bold] Something went wrong")
    ...
    def test_print_warning(self, mock_console):
        ...
        mock_console.print.assert_called_once_with("[yellow]⚠[/yellow] This is a warning")
